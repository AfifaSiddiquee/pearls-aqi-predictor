...
st.markdown(
    "<pstyle='text-align: center;'>This dashboard provides a real-time view of Karachi's air quality, combining live AQI readings with short-term forecasts.
...
with st.spinner("Computing model explanations..."):
    try:
        ...
        fig, ax = plt.subplots(figsize=(11,2))  # compact figure
